...
const objLat = (obj) => {
  ...
  let  firstName =obj.firstName.charAt(0).toUpperCase() +obj.firstName.slice(1).toLowerCase();
  let  lastName =obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1).toLowerCase();
